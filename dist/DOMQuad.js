...
export class DOMQuad {
    ...
    static fromRect(other) {
        return other === undefined
            ? new this()
            : new this(new DOMPoint(other.x, other.y, 0, 1), new DOMPoint(other.x + other.width, other.y, 0, 1), new DOMPoint(other.x + other.width, other.y + other.height, 0, 1), new DOMPoint(other.x, other.y + other.height, 0, 1));
    }
...
//# sourceMappingURL=DOMQuad.js.map